...
function Series () {
    ...
    console.log('series', genreForURL)
    ...
    return (
        <div>
             <span className="uppercase flex font-Montserrat text-[6vw] md:text-[4vw] p-[4px] rounded-[50] text-center justify-center text-white">Discover Series</span>
             <Genres
                type="tv"
